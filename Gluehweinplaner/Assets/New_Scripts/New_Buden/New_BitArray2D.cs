...
public class New_BitArray2D
{
    ...
    public void Reset()
    {
        registeredPlayers = new Dictionary<New_NPC, Vector2Int>();
        array = new BitArray(cellsX * cellsZ);
    }
    public int GetKapa()
    {
    ...
    public void AddPlayer(Vector2Int v, New_NPC ac)
    {
    ...
    public void RemovePlayer(New_NPC ac)
    {
    ...
    public Vector3 FindBestPositionAndAdd(New_NPC ac)
    {
    ...
    public Vector2Int AddInFront(New_NPC ac)
    {
    ...
    public Vector2Int AddToLeft(New_NPC ac)
    {
        for (int x = 0; x < cellsX; x++)
        {
    ...
    //ToDo: Fix this shit
    public Vector2Int AddToRight(New_NPC ac)
    {
        for (int x = 0; x < cellsX; x++)
        {
            for (int z = 0; z < cellsZ; z++)
    ...
    {
        foreach ((New_NPC ac,Vector2Int pos) in registeredPlayers)
        {
