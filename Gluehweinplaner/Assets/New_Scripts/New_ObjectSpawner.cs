...
public class New_ObjectSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        am = GameObject.Find("SceneManager").GetComponent<New_SceneManager>();
...
else if (Mathf.Abs(rotationInput) > 0.01f) 
{
    ...
    void PlaceObject()
    {
        ...
        newObj.GetComponent<New_Bude>().SetTypeIndex(selectedIndex);
        am.AddBude(newObj.GetComponent<New_Bude>());
